 ...
 */
export const getSizeClasses = (size: 'xs' | 'sm' | 'md' | 'lg' | 'xl' = 'md') => {
	const sizeMap = {
 ...
 */
export const getColorClasses = (color: string = 'primary', variant: string = 'solid') => {
	const colorMap = {
		primary: {
		...
		warning: {
			...
			outline: 'border-yellow-600 text-yellow-600 hover:bg-yellow-50 focus:ring-yellow-500',
		...
		light: {
			...
			outline: 'border-gray-300 text-gray-700 hover:bg-gray-50 focus:ring-gray-300',
		...
		dark: {
			...
			outline: 'border-gray-800 text-gray-800 hover:bg-gray-50 focus:ring-gray-700',
